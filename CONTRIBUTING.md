# Contribución a Nexus-Battle-Account
...
```text
feat(account): [HU-21] registrar cuenta de jugador
fix(account): [BUG-12] rechazar el registro con correo duplicado
```
...
- El agregado `Account` no incorpora contraseñas ni secretos de autenticación bajo ninguna circunstancia.
